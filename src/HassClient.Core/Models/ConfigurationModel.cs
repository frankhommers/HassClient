...
namespace HassClient.Core.Models
{
  ...
  public class ConfigurationModel
  {
    ...
    ///   <para>
    ///     URLs can match specific resources (e.g., "http://10.10.10.12/images/image1.jpg") or a relative path that allows
    ...
    /// <summary>
    ///   Gets the currency code according to ISO 4217 (column "Code" from
    ///   <see href="https://en.wikipedia.org/wiki/ISO_4217#Active_codes" />).
    /// </summary>
