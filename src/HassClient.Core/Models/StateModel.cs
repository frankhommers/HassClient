...
namespace HassClient.Core.Models
{
  ...
  public class StateModel
  {
    ...
    ///   Thrown when the specified type <typeparamref name="T" />
    ///   cannot be cast to the attribute's current value.
    /// </exception>
    ...
    {
      return !Attributes.ContainsKey(name) ? default : HassSerializer.DeserializeObject<T>(Attributes[name]);
    }
