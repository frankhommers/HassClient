...
public static class MockHassModelFactory
{
  public static readonly Faker<Device> DeviceFaker =
    new Faker<Device>()
      .CustomInstantiator(f => Device.CreateUnmodified(f.RandomUUID(), f.Commerce.ProductName(), f.RandomUUID(),
        f.Random.Enum<DisabledByEnum>()))
  ...
  public static readonly Faker<ConfigurationModel> ConfigurationFaker =
    new Faker<ConfigurationModel>()
      ...
      .RuleFor(x => x.Elevation, f => f.Random.Int(0))
  ...
  public static readonly Faker<StateModel> StateModelFaker =
    new Faker<StateModel>()
      ...
      .RuleFor(x => x.Attributes,
        (f, x) => new Dictionary<string, JRaw>
          { { "friendly_name", new JRaw($"\"{x.EntityId.SplitEntityId()[1]}\"") } });
  ...
  {
    foreach (string item in entityIds)
  ...
  {
    return faker.RuleFor(x => x.EntityId, f => entityId ?? f.RandomEntityId())
  ...
  public static string RandomUUID(this Faker faker)
  {
    return faker.Random.Hexadecimal(32, string.Empty);
  }

  public static string RandomDomain(this Faker faker)
  {
    return faker.RandomKnownDomain().ToDomainString();
  }

  public static KnownDomains RandomKnownDomain(this Faker faker)
  {
    return faker.Random.Enum<KnownDomains>();
  }

  public static string RandomEntityId(this Faker faker)
  {
    return $"{faker.RandomDomain()}.{faker.Commerce.Product()}";
  }

  public static string RandomEntityState(this Faker faker)
  {
  ...
  public static string RandomIcon(this Faker faker)
  {
    return faker.PickRandom(
      "mdi: lightbulb",
  ...
  {
    for (int i = 0; i < count; i++) yield return generator(faker);
  }
}